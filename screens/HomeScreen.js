...
const HomeScreen = () => {
  ...
  const images = [
    "https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/f61e2097eb7bac82.jpg?q=20",
    "https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/c827ae8d79a1a947.jpg?q=20",
    ...
    <SafeAreaView
      ...
      <ScrollView>
        ...
        >
          ...
          <Pressable>
            <Text style={{ fontSize: 13, fontWeight: "500" }}>Deliver to Avyay - Mumbai 400001</Text>
          </Pressable>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {offers.map((item, index) => (
              <Pressable
                ...
                >
                  <Text
                    style={{ textAlign: "center", color: "white",fontSize: 13,fontWeight: "bold",}} > Upto {item?.offer}</Text>
                </View>
              </Pressable>
            ))}
          </ScrollView>
